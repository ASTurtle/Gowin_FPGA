...
// Generated on: 2024-10-08 15:34:56
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: filter_lowpass
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000010111010110; //sfix16_En15
  parameter signed [15:0] coeff2 = 16'b1110101000110010; //sfix16_En15
  parameter signed [15:0] coeff3 = 16'b1111011100011001; //sfix16_En15
  parameter signed [15:0] coeff4 = 16'b0010011110011100; //sfix16_En15
  parameter signed [15:0] coeff5 = 16'b0100011000100010; //sfix16_En15
  parameter signed [15:0] coeff6 = 16'b0010011110011100; //sfix16_En15
  parameter signed [15:0] coeff7 = 16'b1111011100011001; //sfix16_En15
  parameter signed [15:0] coeff8 = 16'b1110101000110010; //sfix16_En15
  parameter signed [15:0] coeff9 = 16'b0000010111010110; //sfix16_En15
  ...
  assign output_typeconvert = (sum8[30:0] + {sum8[15], {14{~sum8[15]}}})>>>15;
